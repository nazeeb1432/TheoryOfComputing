...
void read_input(){
    freopen("pda_0n1_2n.txt", "r", stdin);
...
char transition(char curr_symbol,char top_of_stack,char current_state){
    ...
    else if(curr_symbol == '1' and top_of_stack == '0' and current_state == 'c'){
        current_state = 'b';
        // s.pop(); do nothing no.5
    }
    ...
    }else if(curr_symbol == 'e' and top_of_stack == z and current_state == 'c'){
        current_state = 'd';   
    }
